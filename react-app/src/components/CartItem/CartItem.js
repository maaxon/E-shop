...
export default class CartItem extends Component{
    render() {
        ...
        const {selectedOptions,attributes,gallery,sm,count,index} = this.props
        ...
        return(
            <div className={classes.wrapper}>
                <div>
                    ...
                    {attributes && attributes.map(attribute=><Option sm selectedOptions={selectedOptions} key={attribute.id} id={attribute.id} name={attribute.name}
